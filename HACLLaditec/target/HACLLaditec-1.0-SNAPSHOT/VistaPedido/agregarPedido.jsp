...
<!DOCTYPE html> <%-- Inicio por Helbert--%>
<html>
  <head>  
    <meta charset="utf-8">
                    ...
                    <div class="card-body pt-0">
                      <form action="Controlador" class="form-horizontal">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="number" min="1" name="txtUsuario" required>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <div class="input-group">
                              <input class="form form-control" type="date" name="txtFecha" required>
                            </div>                          
                          </div>
                        </div>     
